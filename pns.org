...
(add-to-list 'org-capture-templates pns-org-capture-template)
   ...
   #+RESULTS: init
   | - | PNS  | entry | (file+headline c:/Users/fuqiang.luo/OneDrive/Dropbox/project/aspk-new-snippet/snippets/all-mode/inbox.org Captured) | (function pns-create-a-snippet) | :empty-lines-before | 1 |
   | t | Todo | entry | (file+headline c:/Users/fuqiang.luo/OneDrive/Dropbox/org/todo.org Tasks)                                            | * TODO %?                       |                     |   |
...
(setq pns-shortcut-entry-regexp  "^\*+\s+shortcut.*")
    ...
    #+RESULTS: vars
    | - | PNS | entry | (file+headline /Users/astropeak/project/aspk-new-snippet/snippets/all-mode/inbox.org Captured) | (function pns-create-a-snippet) | :empty-lines-before | 1 |
=pns-snippet-dir
==pns-snippet-dir
=    =@
    ==@
