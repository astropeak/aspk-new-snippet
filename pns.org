...
***** example
      ...
      #+RESULTS:
      : (((name . "root") (mode) (var-table) (hungry-vars) (precondition-table) (text . "")) (((name . "headline 1") (mode . "emacs-lisp") (var-table) (hungry-vars) (precondition-table) (text . "elisp"))) (((name . "headline 2") (mode . "python") (var-table) (hungry-vars) (precondition-table) (text . "python"))))
...
***** util func: print a template tree
...
**** convert a src block list to tree
...
**** cretea src block name(belonging entry headline) to template element map, used by helm when expand a template
     #+NAME: methods
     #+begin_src elisp
...
**** expand or open a tempate, by hemp
     #+name: methods
     #+begin_src emacs-lisp
