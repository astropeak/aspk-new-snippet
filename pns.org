...
** issues
*** 190129 make python snippet not indent automatically
    A test code: add below line will do the job to 'pns-expand-template
      ;; (setq hungry-vars '((yas-indent-line 'fixed)))
...
*** DONE use new tree format
    ...
    (defun pns-expand-template-by-name ()
      ...
      (helm-other-buffer
       `(((name . ,(format "Template in %s" (pns-get-current-mode)))
...
*** 190129 BUG '\\' become to '\' after (DEMO VERSION!) expandation
